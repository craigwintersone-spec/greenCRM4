...
// NOTE: Circular Economy removed (out of scope — repair/reuse sector,
// doesn't fit an employability CRM). "events" module now covers Events,
// Feedback and Social Impact (renamed from "Impact Wall").
const SET_MODULES = [
  ...
  { k: 'events',       n: 'Events & Feedback',       d: 'Workshops, feedback surveys, social impact' },
